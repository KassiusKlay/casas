...
st.code('''<!-- Default Statcounter code for Casas
...
src="https://c.statcounter.com/12752694/0/91e69369/1/" alt="Web Analytics"
...
def get_radio_selection():
    ...
    region1 = pd_read_sql(
            ...
            ).name.sort_values(key=utils.remove_accent_from_series).to_list()
    ...
    if radio3 == 'Todos':
        ...
        region2 = pd_read_sql(
                ...
                """
                        ...
                        key=utils.remove_accent_from_series).to_list()
